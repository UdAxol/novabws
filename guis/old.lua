...
local getcustomassets = {
	['nova/assets/old/barlogo.png'] = 'rbxasset://barlogo.png',
	['nova/assets/old/blatanticon.png'] = 'rbxasset://blatanticon.png',
	['nova/assets/old/checkbox.png'] = 'rbxasset://checkbox.png',
	['nova/assets/old/combaticon.png'] = 'rbxasset://combaticon.png',
	['nova/assets/old/friendsicon.png'] = 'rbxasset://friendsicon.png',
	['nova/assets/old/guiicon.png'] = 'rbxasset://guiicon.png',
	['nova/assets/old/info.png'] = 'rbxasset://info.png',
	['nova/assets/old/pin.png'] = 'rbxasset://pin.png',
	['nova/assets/old/profilesicon.png'] = 'rbxasset://profilesicon.png',
	['nova/assets/old/rendericon.png'] = 'rbxasset://rendericon.png',
	['nova/assets/old/search.png'] = 'rbxasset://search.png',
	['nova/assets/old/settingsicon.png'] = 'rbxasset://settingsicon.png',
	['nova/assets/old/targetinfoicon.png'] = 'rbxasset://targetinfoicon.png',
	['nova/assets/old/textguiicon.png'] = 'rbxasset://textguiicon.png',
	['nova/assets/old/textv4.png'] = 'rbxasset://textv4.png',
	['nova/assets/old/textnova.png'] = 'rbxasset://textnova.png',
	['nova/assets/old/utilityicon.png'] = 'rbxasset://utilityicon.png',
	['nova/assets/old/nova.png'] = 'rbxassetid://14373395239',
	['nova/assets/old/worldicon.png'] = 'rbxasset://worldicon.png'
}
	...
	TextList = function(optionsettings, children, api)
		...
		function optionapi:ChangeValue(val)
			...
			for i, v in self.List do
				...
				objectdotin.Image = getcustomasset('nova/assets/old/checkbox.png')
...
function mainapi:CreateBar()
	...
	logo.Image = getcustomasset('nova/assets/old/barlogo.png')
	...
	settingsicon.Image = getcustomasset('nova/assets/old/settingsicon.png')
	...
	searchbutton.ImageLabel.Image = getcustomasset('nova/assets/old/search.png')
...
function mainapi:CreateOverlay(categorysettings)
	...
	pin.Image = getcustomasset('nova/assets/old/pin.png')
...
function mainapi:CreateNotification(title, text, duration, type)
	...
	task.delay(0, function()
		...
		iconshadow.ZIndex = 5
		iconshadow.BackgroundTransparency = 1
		iconshadow.Image = getcustomasset('nova/assets/old/info.png')
		iconshadow.ImageColor3 = Color3.new()
		iconshadow.ImageTransparency = 0.5
...
function mainapi:Load(skipgui, profile)
	...
	if isfile('nova/profiles/'..game.GameId..'.gui.txt') then
		guidata = loadJson('nova/profiles/'..game.GameId..'.gui.txt')
		if not guidata then
			guidata = {Categories = {}}
			self:CreateNotification('Nova', 'Failed to load GUI settings.', 10, 'alert')
			savecheck = false
		end
	...
	if isfile('nova/profiles/'..self.Profile..self.Place..'.txt') then
		local savedata = loadJson('nova/profiles/'..self.Profile..self.Place..'.txt')
		if not savedata then
			...
			self:CreateNotification('Nova', 'Failed to load '..self.Profile..' profile.', 10, 'alert')
			savecheck = false
		end
	...
	if inputService.TouchEnabled and #self.Keybind == 1 and self.Keybind[1] == 'RightShift' then
		...
		image.Image = getcustomasset('nova/assets/old/nova.png')
		image.Parent = button
...
mainapi:CreateCategory({
	Name = 'GUI',
	Icon = getcustomasset('nova/assets/old/guiicon.png')
})
local combat = mainapi:CreateCategory({
	Name = 'Combat',
	Icon = getcustomasset('nova/assets/old/combaticon.png')
})
mainapi:CreateCategory({
	Name = 'Blatant',
	Icon = getcustomasset('nova/assets/old/blatanticon.png'),
	WindowSize = 164
})
mainapi:CreateCategory({
	Name = 'Render',
	Icon = getcustomasset('nova/assets/old/rendericon.png'),
	WindowSize = 196
})
mainapi:CreateCategory({
	Name = 'Utility',
	Icon = getcustomasset('nova/assets/old/utilityicon.png'),
	WindowSize = 164
})
mainapi:CreateCategory({
	Name = 'World',
	Icon = getcustomasset('nova/assets/old/worldicon.png')
})
mainapi:CreateCategory({
	Name = 'Inventory',
	Icon = getcustomasset('nova/assets/old/worldicon.png')
...
local settingspane = mainapi:CreateCategory({
	Name = 'Settings',
	Icon = getcustomasset('nova/assets/old/settingsicon.png'),
	WindowSize = 166
})
...
local friendssettings = {
	Name = 'Friends',
	Icon = getcustomasset('nova/assets/old/friendsicon.png'),
...
mainapi:CreateCategoryList({
	Name = 'Profiles',
	Icon = getcustomasset('nova/assets/old/profilesicon.png'),
...
local textgui = mainapi:CreateOverlay({
	Name = 'Text GUI',
	Icon = getcustomasset('nova/assets/old/textguiicon.png'),
	WindowSize = 178,
	Function = function()
		mainapi:UpdateTextGUI()
	end
...
NovaLogoV4.Size = UDim2.fromOffset(43, 30)
NovaLogoV4.Position = UDim2.new(1, 1, 0, -2)
NovaLogoV4.BackgroundColor3 = Color3.new()
NovaLogoV4.BackgroundTransparency = 1
NovaLogoV4.BorderSizePixel = 0
NovaLogoV4.Image = getcustomasset('nova/assets/old/textv4.png')
...
function mainapi:UpdateTextGUI(afterload)
	...
	if textgui.Button.Enabled then
		...
		NovaLogo.Position = right and UDim2.new(1 / NovaTextScale.Scale, -141, 0, 4) or UDim2.fromOffset(5, 4)
		...
		NovaLabelHolder.Position = UDim2.fromOffset(4, 4 + (NovaLogo.Visible and NovaLogo.Size.Y.Offset or 0))
...
function mainapi:UpdateGUI(hue, sat, val, default)
	...
	if textgui.Button.Enabled then
		...
		NovaLogoGradient2.Color = mainapi.GUIColor.Rainbow and NovaLogoGradient.Color or ColorSequence.new({
			ColorSequenceKeypoint.new(0, Color3.new(1, 1, 1)),
			ColorSequenceKeypoint.new(1, Color3.new(1, 1, 1))
		})
		for i, v in NovaLabels do
			v.Text.TextColor3 = customcolor or (mainapi.GUIColor.Rainbow and Color3.fromHSV(mainapi:Color((hue - ((i + 2) * 0.025)) % 1)) or NovaLogoGradient.Color.Keypoints[2].Value)
		end
	end
